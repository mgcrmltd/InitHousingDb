...
using SetupHousingDB.Factories;
...
namespace SetupHousingDB
{
    public class Program
    {
        ...
        {
            dataGenerator.GenerateEstates();
            dataGenerator.PopulateContextsNoReferenceData(housingContext);
        }
        
        private static void GenerateReferenceData(HousingContextDataService dataGenerator,  HousingDbContext housingContext)
        {
            dataGenerator.GenerateReferenceData();
            dataGenerator.PopulateAllContexts(housingContext);
        }
        ...
        public class HousingContextDataService
        {
            #region Lists
            public List<Address> AddressList = new List<Address>();
            public List<Premises> PremisesList = new List<Premises>();
            public List<PremisesAddress> PremisesAddressList = new List<PremisesAddress>();
            public List<RevenueAccount> RevenueAccountList = new List<RevenueAccount>();
            public List<Tenancy> TenancyList = new List<Tenancy>();
            public List<TenancyPremises> TenancyPremisesList = new List<TenancyPremises>();
            public List<TenancyOccupant> TenancyOccupantList = new List<TenancyOccupant>();
            public List<PremisesGroup> PremisesGroupList = new List<PremisesGroup>();
            public List<PremisesPremisesGroup> PremisesPremisesGroupList = new List<PremisesPremisesGroup>();
            public List<PremisesGroupUserRole> PremisesGroupUserRoleList = new List<PremisesGroupUserRole>();
            public List<ContactMethod> ContactMethodList = new List<ContactMethod>();
            public List<PremisesContactMethod> PremisesContactMethodList = new List<PremisesContactMethod>();
            public List<Tenant> TenantList = new List<Tenant>();
            public List<Role> RoleList = new List<Role>();
            public List<User> UserList = new List<User>();
            public List<Element> ElementList = new List<Element>();
            public List<PremisesElement> PremisesElementList = new List<PremisesElement>();
            public List<Person> PersonList = new List<Person>();
            public List<AddressType> AddressTypeList = new List<AddressType>();
            public List<LeaseType> LeaseTypeList = new List<LeaseType>();
            public List<TenancyType> TenancyTypeList = new List<TenancyType>();
            public List<TenancySource> TenancySourceList = new List<TenancySource>();
            public List<TenureType> TenureTypeList = new List<TenureType>();
            public List<PremisesType> PremisesTypeList = new List<PremisesType>();
            public List<PremisesGroupType> PremisesGroupTypeList = new List<PremisesGroupType>();
            public List<RevenueAccountType> RevenueAccountTypeList = new List<RevenueAccountType>();
            public List<PropertySource> PropertySourceList = new List<PropertySource>();
            ...
            public List<PropertySubType> PropertySubTypeList = new List<PropertySubType>();
            public List<OwnershipType> OwnershipTypeList = new List<OwnershipType>();
            public List<Frequency> FrequencyList = new List<Frequency>();
            private readonly ReferenceDataService _referenceDataService;

            public HousingContextDataService()
            {
                _referenceDataService = new ReferenceDataService(this);
            }
            ...
            private void GenerateEstateData()
            {
            ...
            public void PopulateAllContexts(HousingDbContext context)
            {
            ...
            public void PopulateContextsNoReferenceData(HousingDbContext context)
            {
                context.Addresses.AddRange(AddressList);
                context.Premises.AddRange(PremisesList);
                context.PremisesAddresses.AddRange(PremisesAddressList);
            ...
            {
                _referenceDataService.AddAddressTypes();
                _referenceDataService.AddContactMethods();
                _referenceDataService.AddElements();
                _referenceDataService.AddLeaseTypes();
                _referenceDataService.AddTenancyTypes();
                _referenceDataService.AddTenancySources();
                _referenceDataService.AddTenureTypes();
                _referenceDataService.AddPremisesTypes();
                _referenceDataService.AddPremisesGroupTypes();
                _referenceDataService.AddRevenueAccountTypes();
                _referenceDataService.AddPropertySources();
                _referenceDataService.AddPropertyStatuses();
                _referenceDataService.AddPropertyTypes();
                _referenceDataService.AddPropertySubTypes();
                _referenceDataService.AddOwnershipTypes();
                _referenceDataService.AddFrequencies();
                _referenceDataService.AddRoles();
            }
