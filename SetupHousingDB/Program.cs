...
namespace SetupHousingDB
{
    class Program
    {
        ...
        {
            private const int NumberOfEstates = 4;
            private const int BlocksPerEstate = 3;
            private const int MinFlatsPerBlock = 20;
            private const int MaxFlatsPerBlock = 30;
            private const int HouseCount = 300;
            ...
            private void CreateProperties()
            {
                ...
                for (var i = 0; i < NumberOfEstates; i++)
                {
                ...
                {
                    for (var i = 0; i < BlocksPerEstate; i++)
                    {
                ...
                {
                    var flatCount = Faker.RandomNumber.Next(MinFlatsPerBlock, MaxFlatsPerBlock);
